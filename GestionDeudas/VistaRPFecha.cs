...
{
    public partial class VistaRPFecha : Form
    {
        ObjUsuario usuario;
        Reportes reportes = new Reportes();
        ExportarExcel excel = new ExportarExcel();
        public VistaRPFecha(ObjUsuario objUsuario)
        {
            usuario = objUsuario;
            InitializeComponent();
        }
        ...
        {
            reportes.CargarMovimientosPorFechasEnDGV(dgv, dtpInicio.Value, dtpFinal.Value);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                EnviarMail.EnviarCorreoConPDFEnMemoria(usuario.correo, pdfBytes, "Reporte de sistema", "Reportes por fecha");
        ...
        private void VistaRPFecha_Load(object sender, EventArgs e)
        {
            EstilizarDGV(dgv);
            reportes.CargarMovimientosPorFechasEnDGV(dgv, dtpInicio.Value, dtpFinal.Value);
            ColorearFilasPorTipo(dgv);
