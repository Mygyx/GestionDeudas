...
{
    public partial class VistaRPEmpresas : Form
    {
        Reportes reportes = new Reportes();
        ExportarExcel excel = new ExportarExcel();
        ObjUsuario usuario;
        public VistaRPEmpresas(ObjUsuario usu)
        {
            InitializeComponent();
            usuario = usu;
        }
        ...
        private void VistaRPEmpresas_Load(object sender, EventArgs e)
        {
            EstilizarDGV(dgv);
            reportes.CargarMovimientosFiltradosEnDGVEmpresas(dgv,txtCed.Text);
